...
This script transform a p-value into a score:
    1. Use alpha and lambda to calcuate a threshold P-value.
    2. Calculate a score based on each P-value by alpha and the threshold.
    3. This is a real algorithm. :)
...
Please use Python 3.5+ to run this script. Antiquated Python code is not
supported.
